...
$todouhu = ['東京都','神奈川県','埼玉県','栃木県','千葉県','茨城県','群馬県'];
echo ''. $todouhu[3] . 'と' . $todouhu[4] .'は関東地方の都道府県です。';


// Q7 連想配列-1

$todouhu = ['新宿区','横浜市','千葉市','さいたま市','宇都宮市','前橋市','水戸市'];

foreach ($todouhu as $ken => $city) {
    echo $city . "\n";
}

// Q8 連想配列-2

$todouhu = ['東京都'=>'新宿区', '神奈川県'=>'横浜市', '千葉県'=>'千葉市',
